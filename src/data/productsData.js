export const productsData = [
    {
        ...
        longDesc: [
            ...
            "Born out of deep IT expertise and fuelled by startup energy, enfycon bridges the gap between traditional enterprise systems and next-gen intelligent automation. Our work blends domain knowledge, emerging tech, and patent-pending innovation to deliver real impact — from automating decisions to enhancing customer experiences at scale."
        ],
        icon: "fa-regular fa-comments",
        benefits: [
            {
                title: "Instant, Human-Like Responses",
                desc: "LLM-powered conversations that understand context and user intent instantly.",
                icon: "fa-regular fa-bolt"
            },
            {
                title: "Reduced Operational Costs",
                desc: "Automate up to 80% of routine queries—freeing human agents for complex cases.",
                icon: "fa-regular fa-chart-line-down"
            },
            {
                title: "24x7 Global Scalability",
                desc: "Serve thousands simultaneously across time zones without performance drops.",
            ...
            },
            {
                ...
                desc: "Real-time dashboard with key service metrics and sentiment tracking.",
                icon: "fa-regular fa-chart-pie"
            },
            {
                title: "Secure and Customizable",
                desc: "Enterprise-grade security, compliance, and custom workflows.",
        ...
        howItWorks: [
            {
                ...
                desc: "Users initiate chats via WhatsApp, web, or QR codes placed on packaging, websites, or emails.",
                icon: "fa-regular fa-message-dots"
            },
            {
                title: "WhatsApp Business API",
                desc: "Secure, direct bridge between customer and AI chatbot.",
                icon: "fa-brands fa-whatsapp"
            },
            {
                title: "LLM Chatbot Engine",
                desc: "Processes inputs and responds with intelligent, human-like outputs.",
                icon: "fa-regular fa-microchip"
            },
            {
                title: "AI Interaction Module",
                desc: "Handles complex multi-turn conversations and adapts to user behaviour.",
                icon: "fa-regular fa-robot"
            },
            {
                title: "Data Integration",
                desc: "Seamless sync with CRM, databases, or backend systems.",
                icon: "fa-regular fa-database"
            },
            {
                title: "Performance Dashboard",
                desc: "Real-time KPIs like response time, resolution rate, and satisfaction score.",
        ...
        useCases: [
            {
                ...
                items: [
                    "Automated order tracking, returns, and delivery updates.",
                    "Upsell/cross-sell recommendations based on user behavior.",
                    "QR code-enabled instant support on packaging."
                ],
                icon: "fa-regular fa-cart-shopping"
            },
            {
                title: "Banking, Insurance and FinTech",
                items: [
                    "Account inquiries, KYC, and loan eligibility checks.",
                    "Automated claim processing and premium reminders.",
                    "Reduce wait times during peak events."
                ],
            ...
            },
            {
                ...
                items: [
                    ...
                    "First-level triage (informational only).",
                    "Medical report and billing updates via WhatsApp."
                ],
            ...
            },
            {
                ...
                items: [
                    "Automated admissions and counselling support.",
                    "Curriculum Q and A and exam schedules.",
        ...
        cta: {
            title: "Ready to Revolutionize Customer Engagement?",
            desc: "With iCognito.ai, you're building a smarter, scalable, and more delightful way to engage customers.",
